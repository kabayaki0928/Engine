...
////    }
////
////    // クラス化するほどではないものの混ぜておきたくないので関数から分離していったものの集合体
////    // TODO 分離完了後整理する
////    void createMisc() {
////        CreateContainer container =
////        {
...
////        vertexInputInfo.pVertexBindingDescriptions = nullptr; // 任意
////        vertexInputInfo.vertexAttributeDescriptionCount = 0;
////        vertexInputInfo.pVertexAttributeDescriptions = nullptr; // 任意
////
////        // 頂点バッファの設定
...
////        rasterizer.cullMode = VK_CULL_MODE_BACK_BIT;	// パス単位で指定できる性質のものなのでは？
...
////
////    void drawFrame() {
////        // uint64のmaxを入れた際タイムアウトが無効になる
////        // スワップチェーンは拡張機能であるため、Vk*KHR命名規則のある関数を使用する必要がある
