...
namespace vengine
{
    ...
    /// コンストラクタ
    /// </summary>
    RenderPass::RenderPass(std::shared_ptr<VulkanGraphicsBackend> const graphics_backend) {
    ...
    void RenderPass::create() {
        //RenderPass::create(graphics_backend_, );
    }
    ...
    (
        ...
        colorAttachment.samples = colorMsaaSamples;
        ...
        if (vkCreateRenderPass(graphics_backend->getLogicalDevice(), &renderPassInfo, nullptr, &out_render_pass) != VK_SUCCESS) {
